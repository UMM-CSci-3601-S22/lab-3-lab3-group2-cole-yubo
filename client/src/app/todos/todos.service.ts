...
export class TodoService {
   ...
   */
  getTodos(filters?: { status?: ToDoStatus; owner?: string; category?: string }): Observable<ToDo[]> {
   ...
   */
  filterTodos(todos: ToDo[], filters: { owner?: string; contains?: string; category?: string }): ToDo[] {
